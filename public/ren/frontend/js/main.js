(function ($) {
  ...
  ----------------------------------------*/
    ...
    $(".dropdown-filter, .rt-filter-btn-1").on("click", function () {
        $(".drop_down_2").toggleClass("filter-block");
    });


    $(".dropdown-filter-1").on("click", function () {
        $(".dropdown_1").toggleClass("filter-block");
    });

    $(".dropdown-filter-2").on("click", function () {
        $(".dropdown_2").toggleClass("filter-block");
    });
