...
@push('title')
    <title>Admin|Product Sub Category</title>
...
<div class="content-wrapper">
 ...
 <form action="{{ route('addVendorSubCategory') }}" method="post" enctype="multipart/form-data">
  @csrf
    <div class="container-xxl flex-grow-1 container-p-y">
      <div class="row">
         ...
         <div class="col-md-6">
            <div class="card mb-4">
              <h5 class="card-header">Sub Category Name</h5>
              <div class="card-body demo-vertical-spacing demo-only-element">
                ...
                <div class="form-password-toggle">
                  <label class="form-label" for="basic-default-password12">Select Parent category</label>
                  <div class="input-group">
                    <select  class="form-control" name="parentCat"  required>
                        @if ($catgories->isNotEmpty())
                            @foreach ($catgories as $itemcat)
                              <option value="{{ $itemcat->CategoryID }}" selected>{{ $itemcat->categoryName }}</option>
                            @endforeach
                        @endif
                ...
                <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th scope="col" style="white-space:nowrap">Sub Category Name</th>
                        <th scope="col" style="white-space:nowrap">Parent Category</th>
                    ...
                    <tbody>
                      ...
                      @foreach ($categoriesDetails as $categoryDetails)
                        <tr>
                          ...
                          <td style="font-size:1rem">{{ $categoryDetails->parentCategory->categoryName }}</td>
