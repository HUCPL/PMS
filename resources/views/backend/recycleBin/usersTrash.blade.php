                    ...
                    <tbody>
                      ...
                      @foreach ($userDetails as $users)
                        <tr>
                          ...
                          <td style="white-space: nowrap;"><a class="btn btn-warning" style="color:white;" href="{{ route('usersTrashRestore',['id'=>$users->id]) }}"><i class="fa-solid fa-rotate-right"></i></a>&nbsp;<a class="btn btn-danger" href="{{ route('usersForceDelete',['id'=>$users->id]) }}" style="color:white;" ><i class="fa-solid fa-trash"></i></a></td>
                        </tr>
                      @endforeach
