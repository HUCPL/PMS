        ...
        <div class="row">
            ...
            <div class="card mb-4" style="overflow:scroll; -">
                ...
                <div class="d-flex p-4 justify-content-end">
                        ...
                        data-bs-target="#largeModal">Add New User</a>
                </div>
              <div class="card-body demo-vertical-spacing demo-only-element">
                    ...
                    <tbody>
                      ...
                      @foreach ($userDetails as $users)
                        <tr>
                          ...
                          <td style="font-size:1rem; white-space:nowrap;">{{ $users->name }}</td>
                          <td style="font-size:1rem; white-space:nowrap;">
                            @if ($users->image_path != 'No Url') 
                              <img src="{{url('/').$users->image_path }}" style="width:40px; height:40px;">
                            @else
                                No Image
                            @endif
                          </td>
                          ...
                          <td style="font-size:1rem">
                            ...
                            @elseif ($users->role_as == 4)   
                               HelpDesk  
                            @elseif ($users->role_as == 5)   
                               Owner
                            @elseif ($users->role_as == 6)   
                               HouseKeeper
                            @elseif ($users->role_as == 7)   
                               SuperVisor             
                            @endif
                          </td> 
                          @endif
                ...
                @else
                <div class="alert alert-danger" >Sorry 
                  @if (isset($key))
                   {{ $key }}
                  @else
                  User    
...
<!-- Vertically Centered Modal -->
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div  class="container-fluid" style="width: 100%; padding-left: 11px;padding-right: 11px;
                      " >   
                              <div class="row" style="display:none;" id="addfileds">
                                  <div class="mb-3 col-md-6">
                                  ...
                                  <div class="mb-3 col-md-6">
                                      <label for="exp" class="form-label">Services/Skills</label>
                                      <input
                                      type="text"
                                      class="form-control"
                                      id="exp"
                                      name="skills"
                                      placeholder="Like plumbur, Painter"
                                      data-role="tagsinput"
                                     
                                      />
                                  </div>
                                  <div class="mb-3 col-md-6">
                                      <label for="selectrole" class="form-label">Certificate</label>
                                      <select  class="select2 form-select" name="certificate" id="" >
                                          <option value="">Select Certificate</option>
                                          <option value="0">GST</option>
                                          <option value="1">BRN</option>
                                          <option value="2">Local Residental</option>
                                      </select>
                                  </div>
                                  <div class="mb-3 col-md-6">
                                      <label for="exp" class="form-label" accept="application/pdf">Certificate Attachment</label>
                                      <input
                                      type="file"
                                      class="form-control"
                                      id="exp"
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="selectrole" class="form-label">Give Permission</label>
                            <select  class="select2 form-select" name="role" id="selectrole" required>
   ...
   <div class="modal fade" id="updatelargeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel3">Edit User Details</h5>
          <button
            type="button"
            class="btn-close"
            data-bs-dismiss="modal"
                    ...
                    <div class="row">
                      ...
                      " >   
                              <div class="row"  id="addsfileds">
                                  ...
                                  <div class="mb-3 col-md-6">
                                      <label for="selectrole" class="form-label">Certificate</label>
                                      <select  class="select2 form-select" name="certificate" id="crtf" >
                                          <option value="">Select Certificate</option>
                                          <option value="0">GST</option>
                                          <option value="1">BRN</option>
                                          <option value="2">Local Residental</option>
                                  ...
                                  <div class="mb-3 col-md-6">
                                      <label for="exp" class="form-label">Certificate Attachment</label>
                                      <input
                                      type="file"
                                      class="form-control"
                                      name="certificateAttachment"
                                  ...
                                  <div class="col-mmd-12" id="vendorcertificate"></div>
                              </div>
                        </div>
                      <input type="hidden" id="id" name="id">
                      <div class="mb-3 col-md-6"><br>
