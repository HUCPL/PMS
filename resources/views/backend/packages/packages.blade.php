         ...
         <div class="col-md-12">
            <div class="card mb-4">
              ...
              <div class="card-body demo-vertical-spacing demo-only-element">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <label class="form-label">Services</label>&nbsp;&nbsp;<a
                    data-bs-toggle="modal" data-bs-target="#modalCenterser"
                    class="btn btn-primary" style="color:white;"
                  ><i class="fa-solid fa-plus"></i></a>
                    <div class="mb-3  InputeFlexToChangeFields col-md-12 mt-4">
                  ...
                  <div class="col-md-6">
                      <label class="form-label">Sub Services </label>&nbsp;&nbsp;<a
                      data-bs-toggle="modal" data-bs-target="#modalCenterser"
                      class="btn btn-primary" style="color:white;"
                    ><i class="fa-solid fa-plus"></i></a>
                      <div class="mb-3  InputeFlexToChangeFields col-md-12 mt-4">
                                  ...
                                  <div class="row" id="IBox">
                                      @foreach ($subServices as $subitem)
                                          <div class="col-lg-3 col-md-4 rmv dnone"  data-pid="{{ $subitem->parent_id }}">
                                            <input type="checkbox" name="subservcies[]" id="subs{{ $subitem->id }}" class="proputl subservices" value="{{ $subitem->id }}"/><label for="subs{{ $subitem->id }}"  class="label">{{ $subitem->service_name }}</label>
                                          </div>
