                    ...
                    @endif
                        ...
                        <div class="legendForm card-body demo-vertical-spacing demo-only-element">
                            ...
                            <div class="row">
                                ...
                                @if (Auth::user()->role_as == 10)
                                 <div class="mb-3  InputeFlexToChangeFields col-md-6">
                                  ...
                                  <div class="mb-3  InputeFlexToChangeFields col-md-6">
                                    ...
                                    <select  id="lBox" name="propid" class="form-control" required>
                                ...
                                <div class="mb-3  InputeFlexToChangeFields col-md-6">
                                    <label for="propertySize" class="form-label">Property</label>
                                    <select  id="lBox" name="propid" class="form-control">
                        ...
                        <tbody>
                          ...
                          @foreach ($propertyUnit as $unitList)
                            <tr>
                              ...
                              <td><a class="btn btn-danger" style="color:white;" href="{{ route('deletePropertyUnit',['id'=>$unitList->id]) }}"><i class="fa-solid fa-trash"></i></a>&nbsp;<a class="btn btn-primary" style="color:white;" href="{{ route('updatePropertyUnit',['id'=>$unitList->id]) }}"><i class="fa-solid fa-pen-to-square"></i></a></td>
                            </tr>
                          @endforeach
                        </tbody>
                    </table>
          ...
          @endif
              ...
              <div class="legendForm card-body demo-vertical-spacing demo-only-element">
                  ...
                  <div class="row">
                      ...
                      {{-- <input type="text" value="@if (Session::has('propid')){{ Session::get('propid') }}
                      @endif"> --}}
                      <input type="hidden" value="" name="propid">
                      {{-- <div class="mb-3  InputeFlexToChangeFields col-md-6">
                          <label for="propertySize" class="form-label">Property</label>
