            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="#" class="app-brand-link gap-2">
                  ...
                  <img style="width:180px; display:block; margin:0px auto" src="{{$generaldata->adminlogo_path}}" alt="logo" />
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" action="{{route('superAdminlogin') }}" method="post">
                @csrf
                <div class="mb-3">
                ...
                <input type="hidden" value="{{ str_replace('http','https',$login) }}" name="loginurl">
